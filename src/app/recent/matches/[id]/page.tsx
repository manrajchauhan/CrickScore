  ...
  const fetchMatchDetails = async () => {
    ...
    try {
      ...
      const matchDetail: MatchDetail = {
        ...
        complete: matchInfo.result?.resultType || 'N/A',
        winningTeam: matchInfo.result?.winningTeam || 'N/A',
    ...
    <div className="gap-10 flex mt-10">
        <section className="max-w-full">
          ...
          <div className="text-black flex gap-4 mt-10">
            <h1 className='text-xl font-bold tracking-tight '>Result: <span className='font-normal uppercase'>{match.complete}</span></h1>
