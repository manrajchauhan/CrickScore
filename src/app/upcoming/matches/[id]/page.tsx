  ...
  const fetchMatchDetails = async () => {
    ...
    try {
      ...
      const matchDetail: MatchDetail = {
        ...
        complete: matchInfo.result?.resultType || 'Match Not Started',
    ...
    <div className="gap-10 flex mt-10">
        <section className="max-w-full">
          ...
          <div className="text-black flex gap-4 mt-10">
            <h1 className='text-xl font-bold tracking-tight '>Result: <span className='font-normal normal-case'>{match.complete}</span></h1>
